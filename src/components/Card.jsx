  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-xs xl:text-xl sm:text-xs font-bold w-full flex  flex-col items-center">
          <p className="text-xs font-thin xl:text-xl sm:text-xs sm:font-bold break-words">
            {product.name}
          </p>
          <div className="text-sm md:text-xs lg:text-lg  sm:text-xs text-thin text-[#a5a5a5]">
            5.4 (99)
          </div>
